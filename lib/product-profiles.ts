...
export type ProductProfile = {
  ...
  marketplaceNotes: Partial<Record<'etsy' | 'shopify' | 'amazon' | 'ebay' | 'tiktok' | 'walmart' | 'google', string>>
}
...
export const PRODUCT_PROFILES: ProductProfile[] = [
  {
    ...
    marketplaceNotes: {
      etsy: 'Emphasize design originality, personalization, garment details, and gift occasions.',
      amazon: 'Lead with material, fit, size, and care facts; reduce subjective lifestyle copy.',
      tiktok: 'Lead with the visual hook, fit transformation, or styling moment.',
    },
  },
  {
    id: 'jewelry',
    ...
    marketplaceNotes: {
      etsy: 'Prioritize craftsmanship, material transparency, personalization, and recipient/occasion keywords.',
      ebay: 'State material, hallmarks, dimensions, condition, and included packaging clearly.',
    },
  },
  {
    id: 'home-decor',
    ...
    marketplaceNotes: {
      etsy: 'Use decor style, room, material, and gift/housewarming intent.',
      google: 'Keep titles attribute-led with type, material, color, size, and style.',
    },
  },
  {
    id: 'art-print',
    ...
    marketplaceNotes: {
      etsy: 'Disambiguate digital download versus physical print in the first lines.',
      tiktok: 'Show before/after wall styling or a fast room transformation.',
    },
  },
  {
    ...
    marketplaceNotes: {
      etsy: 'Front-load recipient + occasion + personalization intent.',
      amazon: 'Keep customization choices and lead times structured and explicit.',
    },
  },
  {
    id: 'digital-product',
    ...
    marketplaceNotes: {
      etsy: 'Make “digital download / no physical item” impossible to miss.',
      shopify: 'Clarify fulfillment method and license terms near the purchase CTA.',
    },
  },
  {
    id: 'beauty',
    ...
    marketplaceNotes: {
      amazon: 'Keep claims conservative and ingredient/use facts prominent.',
      tiktok: 'Show texture and routine use without unsupported efficacy promises.',
    },
  },
  {
    id: 'food',
    ...
    marketplaceNotes: {
      amazon: 'Prioritize ingredients, quantity, dietary facts, storage, and compliance.',
      etsy: 'Balance handmade/origin story with allergen and fulfillment clarity.',
    },
  },
  {
    id: 'electronics',
    ...
    marketplaceNotes: {
      amazon: 'Front-load compatibility and key specs.',
      ebay: 'Be explicit about model numbers, condition, included accessories, and compatibility.',
    },
  },
  {
    id: 'accessories',
    ...
    imagePriorities: ['on-body scale', 'inside/capacity', 'closure', 'material close-up', 'dimensions'],
    marketplaceNotes: {},
  },
  {
    id: 'craft-supplies',
    ...
    marketplaceNotes: {
      etsy: 'Use craft type, material, size, quantity, and intended project keywords.',
    },
  },
  {
    id: 'generic',
    ...
    imagePriorities: ['hero image', 'scale', 'details', 'in-use context', 'what is included'],
    marketplaceNotes: {},
  },
]
...
export function inferProductProfile(...parts: Array<string | null | undefined>): ProductProfile {
  ...
  let best = PRODUCT_PROFILES[PRODUCT_PROFILES.length - 1]
  let bestScore = 0
