...
export default function MultichannelPage() {
  ...
  return (
    <div className="container mx-auto max-w-7xl px-4 py-10">
      ...
      <div className="mb-5 rounded-xl border border-border bg-card px-4 py-3 text-sm text-muted-foreground"><strong className="text-foreground">Production connector status:</strong> Etsy, Shopify, WooCommerce and eBay are the first live connector batch. Etsy uses its dedicated shop review/publish workflow; Shopify, WooCommerce and eBay support reviewed direct publishing from multichannel product drafts. Amazon, TikTok Shop, Walmart and Google Shopping remain draft previews only.</div>
