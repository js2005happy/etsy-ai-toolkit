    ...
    <main className="min-h-screen bg-background text-foreground">
      <header className="border-b bg-card/80 backdrop-blur">
        <div className="mx-auto flex max-w-7xl items-center justify-between gap-4 px-5 py-4">
          <Link href="/" className="font-display text-xl font-bold">Craftly</Link>
      ...
      <section className="border-b bg-muted/30">
        <div className="mx-auto max-w-7xl px-5 py-14 md:py-20">
          ...
          <p className="mt-5 max-w-2xl text-lg leading-relaxed text-muted-foreground">Browse seller-published catalogs in one place. This release is discovery-first: checkout, escrow and buyer payments are not enabled yet.</p>
